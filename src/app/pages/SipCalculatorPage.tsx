    ...
    <PageShell title="SIP calculator">
      <Section spacing="lg">
        <Container size="default">
          <h1 className="text-h1 font-display-wonk">SIP calculator</h1>
          <p className="mt-5 max-w-prose text-lead text-ink-secondary">
            A SIP is the same amount invested on the same date every month. Working out what that adds up to for your own goal is a conversation we&rsquo;re happy to have now.
          </p>
